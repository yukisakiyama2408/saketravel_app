    ...
    return (
      <div className="min-h-dvh bg-[#F8F3EC] flex items-center justify-center p-6">
        <div className="w-full max-w-sm text-center">
          ...
          <button
            onClick={() => router.push("/")}
            className="mt-8 text-sm text-[#E8A045] font-medium"
          >
            トップに戻る
          </button>
        </div>
  ...
  return (
    <div className="min-h-dvh bg-[#F8F3EC] flex items-center justify-center p-6">
      <div className="w-full max-w-sm">
        <h1 className="text-2xl font-bold text-[#0D1B2A] mb-1">新規登録</h1>
        ...
        <p className="text-center text-sm text-[#0D1B2A]/50 mt-6">
          すでにアカウントをお持ちの方は{" "}
          <Link href="/auth/login" className="text-[#E8A045] font-medium">
            ログイン
          </Link>
        </p>
      </div>
